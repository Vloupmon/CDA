...
namespace CommerceAPI_NetCore.Models {
    ...
    public partial class Address {
        ...
        public virtual ICollection<Customer> CustomerBillingAddresses {
            get; set;
        }

        public virtual ICollection<Customer> CustomerShippingAddresses {
            get; set;
        }

        public virtual ICollection<Order> OrderBillingAddresses {
            get; set;
        }

        public virtual ICollection<Order> OrderShippingAddresses {
            get; set;
        }
    }
}