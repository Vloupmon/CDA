...
import CommerceAPI.lib.encoders
import os
import logging
import datetime
import uuid
...
server_settings = {
    ...
    "cookie_secret"     :   "ba802658-71c3-4da9-95dc-88ba5067960b",
    "ssl"               :   False,
    "ssl_options"       :   {
...
myapp = {
    ...
    "default_format"    :   "json",
    "encoder"           :   {
           "json"   :   CommerceAPI.lib.encoders.json_to_json(),
            "csv"   :   CommerceAPI.lib.encoders.json_to_csv(),
            "xml"   :   CommerceAPI.lib.encoders.json_to_xml()
    },
    "byte_decoding"     :   "utf-8",
...
database = {
    ...
    "sql"   : {
        ...
        # # this is an example for MSSQL / pyodbc
         "type"      :   "mssql+pyodbc",
         "dbname"    :   "EcommerceSimplifie",        # just a name for non file based DBs
         "host"      :   "127.0.0.1",
         "port"      :   1433,
         "user"      :   "sa",
         "passwd"    :   "",
