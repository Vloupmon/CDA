...
from CommerceAPI.lib.powlib import get_class_name
from CommerceAPI.conf.config import myapp
from CommerceAPI.lib.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('CommerceAPI.models.sql.' + m)
...
#from CommerceAPI.dblib import Base
