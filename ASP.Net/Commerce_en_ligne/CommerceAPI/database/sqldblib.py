...
#
from CommerceAPI.conf.config import database, myapp
...
#from CommerceAPI.models.sql.basemodel import SqlBaseModel
from CommerceAPI.models.sql.sqlmodel import SqlModel
