...
from CommerceAPI.database.sqldblib import Base, Session, engine
from CommerceAPI.conf.config import myapp
from CommerceAPI.conf.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'CommerceAPI.handlers.' + m)    
            try:
                mod = importlib.import_module('CommerceAPI.handlers.' + m)
            except:
                pass
            #print(dir(mod))
