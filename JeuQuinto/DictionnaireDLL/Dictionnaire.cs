...
namespace DictionnaireDLL {
    ...
    public class MotDictionnaire {
        private string _mot = string.Empty;
    ...
    public class MotDictionnaireComparateur : IComparer<MotDictionnaire> {
        ...
        #endregion IComparer<MotDictionnaire> Membres
    }
    ...
    public class Dictionnaire {
        ...
        public List<MotDictionnaire> ExtraireMots(int nombreMots) {
            if (nombreMots >= this._listeMots.Count)
                return this._listeMots.Values.ToList();
        ...
        #endregion Gestion de la persistance
    }
}