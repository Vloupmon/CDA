...
namespace SalariesDll {
    ...
    public class Salarie {
        ...
        public string Matricule {
            ...
            set {
                if (!IsMatriculeValide(value))
                    throw new ApplicationException(string.Format(CultureInfo.CurrentCulture, "Le matricule {0} n'est pas valide.", value));
        ...
        public string Nom {
            ...
            set {
                if (!IsNomPrenomValide(value))
                    throw new ApplicationException(string.Format(CultureInfo.CurrentCulture, "Le nom {0} n'est pas valide.", value));
                ;
        ...
        public string Prenom {
            ...
            set {
                if (!IsNomPrenomValide(value))
                    throw new ApplicationException(string.Format(CultureInfo.CurrentCulture, "Le prénom {0} n'est pas valide.", value));
                ;
        ...
        public virtual decimal SalaireNet {
            get {
                return this._salaireBrut * (1 - this._tauxCS);
            }
        }
        ...
        public static bool IsMatriculeValide(string value) {
            ...
            for (int i = 0; i < value.Length; i++) {
                if ((i < 2 || i > 4) && !char.IsNumber(value[i]))
                    return false;
                if ((i > 2 & i < 5) && !char.IsLetter(value[i]))
                    return false;
            }
            return true;
        }
        ...
        public static bool IsDateNaissanceValide(DateTime value) {
            if (value.CompareTo(new DateTime(1900, 01, 01)) < 0)
                return false;
            if (value.CompareTo(DateTime.Today.AddYears(-15)) > 0)
                return false;
            return true;
        }
        ...
        #endregion Méthodes Surchargées ou Sustituées de la classe Object
    }
}