...
namespace SalariesDll {
    ...
    public class Utilisateur {
        ...
        public int NombreEchecsConsecutifs {
            get {
                return _nombreEchecsConsecutifs;
            }
            set {
                _nombreEchecsConsecutifs = value;
            }
        }
        ...
        public string MotDePasse {
            ...
            set {
                if (IsMotPasseValide(value))
                    _motDePasse = value;
                else
                    throw (new ApplicationException("Mot de passe non valide"));
            }
        }
        ...
        public static bool IsMotPasseValide(string motPasse) {
            if (motPasse == null || motPasse.Length < 5)
                return false;
            return true;
        }
        ...
        public static bool IsIdentifiantValide(string identifiant) {
            if (identifiant == null || identifiant.Length < 4 || !char.IsLetter(identifiant[0]))
                return false;
            return true;
        }
        ...
        public override bool Equals(Object utilisateur) {
            ...
            if (utilisateurRef == null)
                return false;
            else
                return (utilisateurRef.Identifiant == this.Identifiant);
        }
        ...
        public static bool operator ==(Utilisateur utilisateurA, Utilisateur utilisateurB) {
            if ((object)utilisateurA == null)
                return (object)utilisateurB == null;
