...
namespace ORM2.Models {
    ...
    public partial class AFPA2020Entities : DbContext {

        public AFPA2020Entities() {
        }

        public AFPA2020Entities(DbContextOptions<AFPA2020Entities> options)
            : base(options) {
        }

        public virtual DbSet<Entreprise> Entreprises {
            get; set;
        }

        public virtual DbSet<Etablissement> Etablissements {
            get; set;
        }

        public virtual DbSet<OffreFormation> OffreFormations {
            get; set;
        }

        public virtual DbSet<Pee> Pees {
            get; set;
        }

        public virtual DbSet<PeriodePee> PeriodePees {
            get; set;
        }
        ...
        public virtual DbSet<ProduitDeFormation> ProduitDeFormations {
            get; set;
        }

        public virtual DbSet<StagiaireOffreFormation> StagiaireOffreFormations {
            get; set;
        }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            if (!optionsBuilder.IsConfigured) {
                optionsBuilder.UseSqlServer("Server=localhost;Database=AFPA_2020;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Personne>(entity => {
                ...
                entity.HasDiscriminator(e => e.CatPersonne);
            ...
            modelBuilder.Entity<ProduitDeFormation>(entity => {
                ...
                entity.HasDiscriminator(e => e.TypeFormation);
